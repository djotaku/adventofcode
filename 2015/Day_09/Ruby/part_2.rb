...
def traveling_salesman(graph, starting_city, number_of_cities)
    ...
    permutation_list.each do |permutation|
        ...
        max_path = [max_path, current_path_weight].max
    end
    max_path
end
...
if $PROGRAM_NAME == __FILE__
    ...
    puts "Showoff Santa, who wants to visit each city only once, but take the LONGEST route, must travel #{distance} miles."
end
