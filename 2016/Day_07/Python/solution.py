...
def abba_rule(line_to_test: str) -> bool:
    """Return true if the line passes the A BBA rule."""
    regex = re.compile(r'(\w)(\w)\2\1')
    return bool(re.search(regex, line_to_test))
...
if __name__ == '__main__':
    ...
    valid_ipv7_debug = [ip_address for ip_address in ip_addresses_to_check if test_part_one_rule(ip_address)]
    pprint.pprint(valid_ipv7_debug)
