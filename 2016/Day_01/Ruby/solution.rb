...
distance_part_2 = part_two_location[0].abs + part_two_location[1].abs

puts "The distance to Easter Bunny HQ is #{distance_part_1} blocks according to part 1."
puts "The distance to Easter Bunny HQ is #{distance_part_2} blocks according to part 2."